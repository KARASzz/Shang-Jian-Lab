...
def _parse_pipeline(raw: dict[str, Any]) -> PipelineConfig:
    cfg = PipelineConfig(
        ...
        topic_research_sources_max_per_round=int(raw.get("topic_research_sources_max_per_round", 24)),
        topic_research_min_valid_channels=int(raw.get("topic_research_min_valid_channels", 2)),
        topic_research_min_sources_total=int(raw.get("topic_research_min_sources_total", 40)),
        scrapy_max_pages=int(raw.get("scrapy_max_pages", 96)),
    )
